...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_users/google-people/apis.yaml
...
- name: Google People API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_users/google-people/v1-people-batchget-get.md
- name: Google People API
  description: The People API lets you list authenticated users Contacts and retrieve
    profile information for authenticated users and their contacts
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-people.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_users/google-people/v1-resourcename-get.md
- name: Google People API
  description: The People API lets you list authenticated users Contacts and retrieve
    profile information for authenticated users and their contacts
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-people.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_users/google-people/v1-resourcename-connections-get.md
x-common:
- type: x-code-builder
