...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/apis.yaml
...
- name: AWS Polly API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/action-deletelexicon-k-1-get.md
- name: AWS Polly API
  description: Amazon Polly is a service that turns text into lifelike speech
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-polly.jpg
  humanURL: https://aws.amazon.com/polly/
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/action-describevoices-k-1-get.md
- name: AWS Polly API
  description: Amazon Polly is a service that turns text into lifelike speech
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-polly.jpg
  humanURL: https://aws.amazon.com/polly/
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/action-getlexicon-k-1-get.md
- name: AWS Polly API
  description: Amazon Polly is a service that turns text into lifelike speech
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-polly.jpg
  humanURL: https://aws.amazon.com/polly/
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/action-listlexicons-k-1-get.md
- name: AWS Polly API
  description: Amazon Polly is a service that turns text into lifelike speech
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-polly.jpg
  humanURL: https://aws.amazon.com/polly/
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/action-putlexicon-k-1-get.md
- name: AWS Polly API
  description: Amazon Polly is a service that turns text into lifelike speech
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-polly.jpg
  humanURL: https://aws.amazon.com/polly/
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_voice/aws-polly/action-synthesizespeech-k-1-get.md
x-common:
