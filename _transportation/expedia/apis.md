...
- name: Expedia API
  ...
  baseURL: http://developer.ean.com/
  tags:
  - Gallery
  properties:
  - type: x-openapi-spec
...
- name: Expedia API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_transportation/expedia/m-api-trip-calculatepoints-post.md
x-common:
- type: x-crunchbase
