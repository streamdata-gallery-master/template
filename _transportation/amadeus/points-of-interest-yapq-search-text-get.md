...
paths:
  /points-of-interest/yapq-search-text:
    get:
      ...
      description: Amadeus has partnered with <a href="http://yapq
      ...
      - in: query
        name: city_name
        description: The name of the <a href="http://yapq
      - in: query
        name: geonames
      ...
      - in: query
        name: vibes
        description: Includes content that doesn't correspond to an active physical
          place, but which gives the user some background information, or <em>vibe</em>
