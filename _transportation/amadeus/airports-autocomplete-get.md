...
paths:
  /airports/autocomplete:
    get:
      ...
      description: <p>Using the term parameter and given the start of any word in
        an airport's official name, a city name, or the start of an <a href="https://en
      ...
      - in: query
        name: country
        description: Identified a country based of a <a href="https://en
      - in: query
        name: term
