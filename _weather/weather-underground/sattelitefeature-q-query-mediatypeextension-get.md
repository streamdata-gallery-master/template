...
paths:
  /{satteliteFeature}/q/{query}{mediaTypeExtension}:
    get:
      summary: Get Satellite Featuer Query Media Type Extension
      description: Get sattelitefeature q query mediatypeextension
      operationId: getSattelitefeatureQQueryMediatypeextension
      parameters:
      - in: path
      ...
      - in: path
        ...
        description: |-
          ...
          http://www
      - in: path
        name: satteliteFeature
        description: satellite (single frame) or animatedsatellite (6-frame animation
          by default; must be gif format)
      responses:
        200:
          description: OK
      tags:
