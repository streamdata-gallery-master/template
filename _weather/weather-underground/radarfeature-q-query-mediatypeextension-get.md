...
paths:
  /{radarFeature}/q/{query}{mediaTypeExtension}:
    get:
      summary: Get Radar Feature Query Media Type Extension
      description: Get radarfeature q query mediatypeextension
      operationId: getRadarfeatureQQueryMediatypeextension
      parameters:
      - in: path
        name: mediaTypeExtension
        description: gif, png, or swf
      - in: path
        name: query
        description: |-
      ...
      - in: path
        name: radarFeature
        description: radar (single frame) or animatedradar (6-frame animation by default;
          must be gif or swf format)
      responses:
        200:
          description: OK
      tags:
