...
created: "2018-02-17"
modified: "2018-02-17"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/apis.yaml
...
- name: Wunderground API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/radarfeature-image-mediatypeextension-get.md
- name: Wunderground API
  description: Weather Underground is committed to delivering the most reliable, accurate
    weather information possible
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/966_logo.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/radarfeature-q-query-mediatypeextension-get.md
- name: Wunderground API
  description: Weather Underground is committed to delivering the most reliable, accurate
    weather information possible
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/966_logo.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/radarsattelitefeatures-image-mediatypeextension-get.md
- name: Wunderground API
  description: Weather Underground is committed to delivering the most reliable, accurate
    weather information possible
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/966_logo.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/radarsattelitefeatures-q-query-mediatypeextension-get.md
- name: Wunderground API
  description: Weather Underground is committed to delivering the most reliable, accurate
    weather information possible
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/966_logo.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/sattelitefeature-image-mediatypeextension-get.md
- name: Wunderground API
  description: Weather Underground is committed to delivering the most reliable, accurate
    weather information possible
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/966_logo.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_weather/wunderground-api/sattelitefeature-q-query-mediatypeextension-get.md
x-common:
