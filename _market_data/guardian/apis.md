...
created: "2018-02-16"
modified: "2018-02-16"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_market_data/guardian/apis.yaml
specificationVersion: "0.14"
apis:
- name: Guardian Content API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_market_data/guardian/editions.md
- name: Guardian Content API
  description: The Guardian is a British national daily newspaper which has grown
    into a national paper associated with a complex organisational structure and an
    international multimedia and web presence
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_market_data/guardian/search.md
- name: Guardian Content API
  description: The Guardian is a British national daily newspaper which has grown
    into a national paper associated with a complex organisational structure and an
    international multimedia and web presence
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_market_data/guardian/sections.md
- name: Guardian Content API
  description: The Guardian is a British national daily newspaper which has grown
    into a national paper associated with a complex organisational structure and an
    international multimedia and web presence
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_market_data/guardian/tags.md
x-common:
- type: x-access-tiers
