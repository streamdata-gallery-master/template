...
- name: SendGrid
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/subusers-subuser-name-stats-monthly-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-blocks-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-blocks-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-blocks-email-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-blocks-email-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-bounces-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-bounces-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-bounces-email-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-bounces-email-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-invalid-emails-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-invalid-emails-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-invalid-emails-email-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-invalid-emails-email-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-spam-reports-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-spam-reports-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-spam-reports-email-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-spam-reports-email-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/suppression-unsubscribes-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-pending-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-pending-token-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-pending-token-resend-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-username-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-username-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/teammates-username-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-versions-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-versions-version-id-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-versions-version-id-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-versions-version-id-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/templates-template-id-versions-version-id-activate-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-click-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-click-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-google-analytics-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-google-analytics-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-open-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-open-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-subscription-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/tracking-settings-subscription-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-account-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-credits-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-email-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-email-put.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-password-put.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-profile-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-profile-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-scheduled-sends-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-scheduled-sends-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-scheduled-sends-batch-id-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-scheduled-sends-batch-id-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-scheduled-sends-batch-id-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-settings-enforced-tls-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-settings-enforced-tls-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-username-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-username-put.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-event-settings-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-event-settings-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-event-test-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-parse-settings-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-parse-settings-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-parse-settings-hostname-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-parse-settings-hostname-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-parse-settings-hostname-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/user-webhooks-parse-stats-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-default-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-subuser-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-subuser-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-domain-id-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-domain-id-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-domain-id-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-domain-id-subuser-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-id-ips-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-id-ips-ip-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-domains-id-validate-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-ips-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-ips-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-ips-id-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-ips-id-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-ips-id-validate-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-default-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-subuser-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-subuser-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-id-delete.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-id-get.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-id-patch.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-id-validate-post.md
- name: SendGrid
  description: SendGrid is a cloud-based email service that delivers email on behalf
    of companies to increase deliverability and improve customer communications integration
    with new or existing email systems is done via SMTP or through a REST API, providing
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_messaging/sendgrid/whitelabel-links-link-id-subuser-post.md
x-common:
- type: x-c-sharp
