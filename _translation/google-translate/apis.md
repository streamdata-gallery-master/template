...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_translation/google-translate/apis.yaml
...
- name: Google Translate API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_translation/google-translate/v2-get.md
- name: Google Translate API
  description: Cloud Translation API provides a simple programmatic interface for
    translating an arbitrary string into any supported language
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-translate-hello-lead-2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_translation/google-translate/v2-detect-get.md
- name: Google Translate API
  description: Cloud Translation API provides a simple programmatic interface for
    translating an arbitrary string into any supported language
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-translate-hello-lead-2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_translation/google-translate/v2-languages-get.md
x-common:
- type: x-attribution
