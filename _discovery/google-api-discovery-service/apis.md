...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_discovery/google-api-discovery-service/apis.yaml
...
- name: Google API Discovery Service API
  ...
  baseURL: https://developers.google.com/discovery/
  tags:
  - Gallery
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_discovery/google-api-discovery-service/apis-get.md
- name: Google API Discovery Service API
  description: You can use the Google API Discovery Service to build client libraries,
    IDE plugins, and other tools that interact with Google APIs
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Screen
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_discovery/google-api-discovery-service/apis-api-version-rest-get.md
x-common:
