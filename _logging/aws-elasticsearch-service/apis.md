...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_logging/aws-elasticsearch-service/apis.yaml
...
- name: Amazon Elasticsearch Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_logging/aws-elasticsearch-service/2015-01-01-es-domain-info-post.md
- name: Amazon Elasticsearch Service API
  description: Amazon Elasticsearch Service makes it easy to deploy, operate, and
    scale Elasticsearch for log analytics, full text search, application monitoring,
    and more
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_logging/aws-elasticsearch-service/2015-01-01-es-domain-domain-name-get.md
- name: Amazon Elasticsearch Service API
  description: Amazon Elasticsearch Service makes it easy to deploy, operate, and
    scale Elasticsearch for log analytics, full text search, application monitoring,
    and more
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_logging/aws-elasticsearch-service/2015-01-01-es-domain-domain-name-config-get.md
- name: Amazon Elasticsearch Service API
  description: Amazon Elasticsearch Service makes it easy to deploy, operate, and
    scale Elasticsearch for log analytics, full text search, application monitoring,
    and more
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_logging/aws-elasticsearch-service/2015-01-01-es-domain-domain-name-config-post.md
x-common:
- type: x-console
