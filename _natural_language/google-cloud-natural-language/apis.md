...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_natural_language/google-cloud-natural-language/apis.yaml
...
- name: Google Cloud Natural Language API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_natural_language/google-cloud-natural-language/v1-documents-analyzeentities-post.md
- name: Google Cloud Natural Language API
  description: Google Cloud Natural Language API reveals the structure and meaning
    of text by offering powerful machine learning models in an easy to use REST API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/powerful-text-analysis-2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_natural_language/google-cloud-natural-language/v1-documents-analyzesentiment-post.md
- name: Google Cloud Natural Language API
  description: Google Cloud Natural Language API reveals the structure and meaning
    of text by offering powerful machine learning models in an easy to use REST API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/powerful-text-analysis-2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_natural_language/google-cloud-natural-language/v1-documents-analyzesyntax-post.md
- name: Google Cloud Natural Language API
  description: Google Cloud Natural Language API reveals the structure and meaning
    of text by offering powerful machine learning models in an easy to use REST API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/powerful-text-analysis-2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_natural_language/google-cloud-natural-language/v1-documents-annotatetext-post.md
x-common:
- type: x-change-log
