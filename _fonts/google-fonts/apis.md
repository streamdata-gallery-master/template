...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_fonts/google-fonts/apis.yaml
specificationVersion: "0.14"
apis:
- name: Google Fonts API
  description: Create dynamic apps by querying Google Fonts to get an accurate list
    of the families currently available
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Screen
    Shot 2017-03-17 at 8.18.48 PM.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_fonts/google-fonts/webfonts-get.md
x-common:
- type: x-blog
...
- type: x-twitter
  url: https://twitter.com/googlefonts
- type: x-website
