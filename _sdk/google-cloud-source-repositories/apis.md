...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/apis.yaml
...
- name: Cloud Source Repositories API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-name-delete.md
- name: Cloud Source Repositories API
  description: Google Cloud Source Repositories provides Git version control to support
    collaborative development of any application or service, including those that
    run on Google App Engine and Google Compute Engine
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-name-get.md
- name: Cloud Source Repositories API
  description: Google Cloud Source Repositories provides Git version control to support
    collaborative development of any application or service, including those that
    run on Google App Engine and Google Compute Engine
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-name-repos-get.md
- name: Cloud Source Repositories API
  description: Google Cloud Source Repositories provides Git version control to support
    collaborative development of any application or service, including those that
    run on Google App Engine and Google Compute Engine
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-parent-repos-post.md
- name: Cloud Source Repositories API
  description: Google Cloud Source Repositories provides Git version control to support
    collaborative development of any application or service, including those that
    run on Google App Engine and Google Compute Engine
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-resource-getiampolicy-get.md
- name: Cloud Source Repositories API
  description: Google Cloud Source Repositories provides Git version control to support
    collaborative development of any application or service, including those that
    run on Google App Engine and Google Compute Engine
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-resource-setiampolicy-post.md
- name: Cloud Source Repositories API
  description: Google Cloud Source Repositories provides Git version control to support
    collaborative development of any application or service, including those that
    run on Google App Engine and Google Compute Engine
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_sdk/google-cloud-source-repositories/v1-resource-testiampermissions-post.md
x-common:
- type: x-concepts
