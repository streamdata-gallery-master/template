...
paths:
  /{media-fingerprint-id}:
    put:
      summary: Update Media Fingerprint
      description: Media Fingerprint
      operationId: updateMediaFingerprint
      parameters:
      - in: path
        name: media-fingerprint-id
        type: string
      responses:
        200:
          ...
          schema:
            type: array
            items:
              $ref: '#/definitions/Media Fingerprint'
      tags:
      - media fingerprint
definitions:
  Canvas_Button:
