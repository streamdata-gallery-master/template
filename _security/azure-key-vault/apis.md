...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_security/azure-key-vault/apis.yaml
...
- name: Azure Key Vault API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_security/azure-key-vault/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-keyvault-vaults-get.md
- name: Azure Key Vault API
  description: Azure Key Vault offers an easy, cost-effective way to safeguard keys
    and other secrets in the cloud by using hardware security modules (HSMs)
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/azure-enhance-data-protection.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_security/azure-key-vault/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-keyvault-vaults-vaultname-delete.md
- name: Azure Key Vault API
  description: Azure Key Vault offers an easy, cost-effective way to safeguard keys
    and other secrets in the cloud by using hardware security modules (HSMs)
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/azure-enhance-data-protection.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_security/azure-key-vault/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-keyvault-vaults-vaultname-get.md
- name: Azure Key Vault API
  description: Azure Key Vault offers an easy, cost-effective way to safeguard keys
    and other secrets in the cloud by using hardware security modules (HSMs)
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/azure-enhance-data-protection.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_security/azure-key-vault/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-keyvault-vaults-vaultname-put.md
- name: Azure Key Vault API
  description: Azure Key Vault offers an easy, cost-effective way to safeguard keys
    and other secrets in the cloud by using hardware security modules (HSMs)
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/azure-enhance-data-protection.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_security/azure-key-vault/subscriptions-subscriptionid-resources-get.md
x-common:
