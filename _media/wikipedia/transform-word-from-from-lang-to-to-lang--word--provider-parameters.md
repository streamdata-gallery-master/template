...
paths:
  /transform/word/from/{from_lang}/to/{to_lang}/{word}/{provider}:
    parameters:
      summary: Fetches the dictionary meaning of a word from a language and displays
        it in the target language.
      description: Fetches the dictionary meaning of a word from a language and displays
        it in the target language
      operationId: fetches-the-dictionary-meaning-of-a-word-from-a-language-and-displaysit-in-the-target-languagestabil
      responses:
        200:
          description: OK
      tags:
