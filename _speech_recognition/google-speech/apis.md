...
description: Google Cloud Speech API enables developers to convert audio to text by
  ...
  the text of users dictating to an applicationrsquo;s microphone, enable command-and-control
...
created: "2018-02-22"
modified: "2018-02-22"
url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/apis.yaml
...
- name: Google Cloud Speech API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/v1beta1-operations-get.md
- name: Google Cloud Speech API
  description: Google Cloud Speech API enables developers to convert audio to text
    by applying powerful neural network models in an easy to use API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/speech-api-lead_2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/v1beta1-operations-name-delete.md
- name: Google Cloud Speech API
  description: Google Cloud Speech API enables developers to convert audio to text
    by applying powerful neural network models in an easy to use API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/speech-api-lead_2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/v1beta1-operations-name-get.md
- name: Google Cloud Speech API
  description: Google Cloud Speech API enables developers to convert audio to text
    by applying powerful neural network models in an easy to use API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/speech-api-lead_2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/v1beta1-operations-name-cancel-post.md
- name: Google Cloud Speech API
  description: Google Cloud Speech API enables developers to convert audio to text
    by applying powerful neural network models in an easy to use API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/speech-api-lead_2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/v1beta1-speech-asyncrecognize-post.md
- name: Google Cloud Speech API
  description: Google Cloud Speech API enables developers to convert audio to text
    by applying powerful neural network models in an easy to use API
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/speech-api-lead_2x.png
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/apis/master/_speech_recognition/google-speech/v1beta1-speech-syncrecognize-post.md
x-common:
- type: x-code-builder
